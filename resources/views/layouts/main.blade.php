            ...
            <div class="container">
                <div class="d-flex">
                    ...
                    <div class="d-flex order-lg-2 ml-auto">
                      ...
                      <span class="text-default">{{ auth()->user()->description }}</span>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-3 ml-auto">
                        @if(auth()->user()->role == 'ta' || auth()->user()->role == 'instructor')
                        <ul class="nav nav-tabs border-0 flex-column flex-lg-row justify-content-end">
                            <li class="nav-item">
                                <a href="javascript:void(0)" @if(request()->is('admin*')) class="nav-link active" @else class="nav-link" @endif data-toggle="dropdown"><i class="fe fe-file"></i>@if(auth()->user()->role == 'instructor') Admin @else Systems @endif Menu</a>
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                    <a href="{{ route('admin.monitor.index') }}" class="dropdown-item ">ตรวจสอบทรัพยากร</a>
                                    <a href="{{ route('admin.activelab') }}" class="dropdown-item ">การทดลองที่ดำเนินอยู่</a>
