                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="selectgroup w-100">
                                        <label class="selectgroup-item">
                                            <input type="radio" name="role" value="student" class="selectgroup-input" checked="">
                                            <span class="selectgroup-button">นักศึกษา</span>
                                        </label>
                                        <label class="selectgroup-item">
                                            <input type="radio" name="role" value="ta" class="selectgroup-input">
                                            <span class="selectgroup-button">ผู้ช่วยสอน</span>
                                        </label>
                                        <label class="selectgroup-item">
                                            <input type="radio" name="role" value="instructor" class="selectgroup-input">
                            ...
                            <div class="col-sm-6 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control @if($errors->has('name')) is-invalid @endif" placeholder="ชื่อ-สกุล / ชื่อที่ต้องการให้แสดงในระบบ">
                                    @if($errors->has('name'))
