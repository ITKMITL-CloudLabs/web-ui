...
@section('content')
    ...
    <div class="row">
        <div class="col-sm-6 col-lg-3">
            <div class="card">
                <div class="card-body text-center">
                    <div class="h5"><strong>Instances (เครื่อง)</strong><br><small>จำกัด 3 เครื่อง</small></div>
                    <div class="display-4 font-weight-bold mb-4">3</div>
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="card">
                <div class="card-body text-center">
                    <div class="h5"><strong>vCPUs (Core)</strong><br><small>จำกัด 1 Cores</small></div>
                    <div class="display-4 font-weight-bold mb-4">1</div>
                    <div class="progress progress-sm">
                        <div class="progress-bar bg-green" style="width: 100%"></div>
                    </div>
                </div>
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="card">
                <div class="card-body text-center">
                    <div class="h5"><strong>Memory (MB)</strong><br><small>จำกัด 256 MB</small></div>
                    <div class="display-4 font-weight-bold mb-4">201 MB</div>
                    <div class="progress progress-sm">
                        <div class="progress-bar bg-green" style="width: 91%"></div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-body text-center">
                    <div class="h5"> <strong>Disk Space (GB)</strong><br>
                        <small>จำกัด 100 GB</small></div>
                    <div class="display-4 font-weight-bold mb-4">20 GB</div>
                    <div class="progress progress-sm">
    ...
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="btn-group">
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#createInstanceModal"><i class="fa fa-hdd-o"></i>สร้าง Instance</button>
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#createSubnetModal"><i class="fa fa-plus"></i>สร้าง Subnet</button>
                                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#createRouterModal"><i class="fa fa-plus"></i>สร้าง Router</button>
                            </div>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <img src="{{ asset('assets/topo.jpg') }}" width="40%" alt="">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <h4>ขั้นตอนการทดลอง</h4>
                    <img src="{{ asset('assets/1.png') }}" width="40%" alt="">
                    <ol>
                        <li>นักศึกษาเข้าสู่ระบบด้วยชื่อผู้ใช้และรหัสผ่านของนักศึกษา</li>
                        <li>เลือกการทดลองตัวอย่าง จากนั้นคลิกปุ่ม &ldquo;เริ่มทำการทดลอง&rdquo;</li>
                        <li>สร้าง Network ตามโจทย์กำหนด
                            <ul>
                                <li>สร้าง Subnet ที่มี CIDR เป็น 0.0.0/24</li>
                                <li>สร้าง Subnet ที่มี CIDR เป็น 10.0.1.0/24</li>
                            </ul>
                        </li>
                        <li>สร้าง Virtual Machine ตามโจทย์กำหนด
                            <ul>
                                <li>สร้าง VM1 โดยเลือก Network เป็น Subnet 10.0.0.0/24</li>
                                <li>สร้าง VM2 โดยเลือก Network เป็น Subnet 10.0.0.0/24</li>
                                <li>สร้าง VM3 โดยเลือก Network เป็น Subnet 10.0.1.0/24</li>
                            </ul>
                        </li>
                        <li>สร้าง Router ระหว่างเครือข่ายตามโจทย์กำหนด</li>
                        <li>ทดสอบการทำงานตามตารางแสดงผลลัพท์</li>
                    </ol>
                </div>
            </div>
        </div>
